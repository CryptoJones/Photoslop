...
| Desktop distributable | v1.30.0 explicitly unsigned; later tags secret-gated | device signing required; no public bundle | wheel/sdist CI smoke | installed with Python package |

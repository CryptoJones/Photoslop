...
| Selections/filters/vectors/text | ✅ | 🟡 magic wand + pixel selections (Select All / Invert / Delete Selection); editable text layers; the seven built-in filters, pixel-identical to the desktop | ✅ shared safe engine operations | ✅ safe subset |

...
An honest, category-by-category comparison of **Photoslop v2.36.0** against six
...
| One-bit dither / beam modulation | ✅ Beam Dither, 11 algorithms | ✅ ported, fixture-proven word for word | ✅ `--filter beam-dither:…` | — |
| Live appearance effects (shadow, glow, outline, overlay, bevel) | ✅ 10 kinds on any layer | ✅ 10 kinds on any layer, ported from the desktop renderer, fixture-proven identical, Gaussian blur and feather included | ✅ `--drop-shadow`, `--glow`, `--stroke`, `--effect`, `--set-effects` | ✅ safe subset |
...
| Desktop distributable | macOS signed and notarized (verified v2.9.0); Windows unsigned; tags secret-gated | device signing required; no public bundle | wheel/sdist CI smoke | installed with Python package |

## Versions compared

| Product | Version (July 2026) | License / price | Platforms |
|---|---|---|---|
| **Photoslop** | 2.36.0 | Apache-2.0, free | Linux / Windows / macOS (Qt), iPadOS / iOS |
...
| Paint bucket / flood fill (tolerance) | ✅ desktop + iOS | ✅ | ✅ | ✅ | — | — | — |
| Pattern fill | ✅ | ✅ | ✅ | ❌ | — | — | — |
...
| Live layer effects (shadow/glow/stroke) | ✅ (desktop; iOS on text layers) | ✅ (full styles engine) | 🟡 (via GEGL filters/script) | 🟡 (effect plugins, baked) | — | — | — |
...
| Ordered text/layer appearance effects and presets | ✅ (10 live effects; ORA + SVG filters; 8 live on iOS text layers with the same presets) | ✅ | 🟡 | 🟡 | — | — | — |
...
| Headless CLI | ✅ **63 shared engine ops** [CLI](cli.md) | ❌ | ✅ (`gimp -i -b`, script-driven) | ❌ | ❌ | ✅ (`darktable-cli`, export-focused) | ❌ |
...
- **Headless automation through a shared engine.** All 63 operations are shared

...
An honest, category-by-category comparison of **Photoslop v2.27.0** against six
...
| Selections/filters/vectors/text | ✅ | 🟡 wand, marquee and lasso selections with feathering; brushes, bucket and Delete Selection honour them; editable text layers; the seven built-in filters, pixel-identical to the desktop; no vectors yet | ✅ shared safe engine operations | ✅ safe subset |
...
|---|---|---|---|
| **Photoslop** | 2.27.0 | Apache-2.0, free | Linux / Windows / macOS (Qt), iPadOS / iOS |

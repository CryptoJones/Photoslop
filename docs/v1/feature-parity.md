...
An honest, category-by-category comparison of **Photoslop v2.35.0** against six
...
|---|---|---|---|
| **Photoslop** | 2.35.0 | Apache-2.0, free | Linux / Windows / macOS (Qt), iPadOS / iOS |
...
| Headless CLI | ✅ **62 shared engine ops** [CLI](cli.md) | ❌ | ✅ (`gimp -i -b`, script-driven) | ❌ | ❌ | ✅ (`darktable-cli`, export-focused) | ❌ |
...
- **Headless automation through a shared engine.** All 62 operations are shared

...
An honest, category-by-category comparison of **Photoslop v2.5.0** against six
...
| Desktop distributable | v2.5.0 macOS signed/not notarized; Windows unsigned; later tags secret-gated | device signing required; no public bundle | wheel/sdist CI smoke | installed with Python package |

## Versions compared

| Product | Version (July 2026) | License / price | Platforms |
|---|---|---|---|
| **Photoslop** | 2.5.0 | Apache-2.0, free | Linux / Windows / macOS (Qt), iPadOS / iOS |

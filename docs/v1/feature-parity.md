...
An honest, category-by-category comparison of **Photoslop v1.6.0** against six
...
|---|---|---|---|
| **Photoslop** | 1.6.0 | Apache-2.0, free | Linux / Windows / macOS (Qt) |
...
| Big filter library | ✅ (G'MIC + GEGL packs) [Filter Plugins](filter-plugins.md) | ✅ (hundreds) | ✅ (GEGL + G'MIC) | ✅ (plugin ecosystem) | — | ✅ (70+ modules) | 🟡 (styles) |
